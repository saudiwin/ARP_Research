...
constrain_legis <- sort(c(which(row.names(votes_matrix)==first_d_constraint),which(row.names(votes_matrix)==second_d_constraint)))
...
saveRDS(sample_fit,"oned_arp2_stan1000.rds")
